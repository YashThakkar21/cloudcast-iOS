...
// Revisit and start from step 3: Try putting a breakpoint after jsonDictionary has been assigned. See that it's just a regular dictionary whose structure is similar to the JSON object you saw in Postman earlier!
